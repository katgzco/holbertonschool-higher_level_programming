<h1 class="gap">0x0A. Python - Inheritance</h1><div class="gap" id="project-description">
<h2>Resources</h2>
<p><strong>Read or watch</strong>:</p>
<ul>
<li><a href="/rltoken/E2Bs3bxX8GuSEKuWqswU7g" target="_blank" title="Inheritance">Inheritance</a> </li>
<li><a href="/rltoken/auwnZOKkBZ97JaLtrMryuA" target="_blank" title="Multiple inheritance">Multiple inheritance</a> </li>
<li><a href="/rltoken/ycewwwPmDpXqRp2R1FW51w" target="_blank" title="Inheritance in Python">Inheritance in Python</a> </li>
<li><a href="/rltoken/F8LUzmvPI4yur1Z37ZM1fQ" target="_blank" title="Learn to Program 10 : Inheritance Magic Methods">Learn to Program 10 : Inheritance Magic Methods</a> </li>
</ul>
<h2>Learning Objectives</h2>
<p>At the end of this project, you are expected to be able to <a href="/rltoken/hdN09jbXotPDd8FfgfJdIQ" target="_blank" title="explain to anyone">explain to anyone</a>, <strong>without the help of Google</strong>:</p>
<h3>General</h3>
<ul>
